...
<div class="container mx-auto px-4 py-12">
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-16">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
      ...
      <div class="p-6">
        <h2 class="text-xl font-bold text-gray-800 mb-2">Banner Downloader</h2>
        <p class="text-gray-600 mb-4">Download high-quality banner images from any YouTube channel</p>
        <a href="/tools/banner-downloader" class="text-blue-600 hover:text-blue-800 font-medium inline-flex items-center">
          Try it now
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
          </svg>
