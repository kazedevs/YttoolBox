<script>
    ...
    import { extractYoutubeVideoId, getThumbnailUrls } from '$lib/youtube';
  ...
  <svelte:head>
    ...
    <meta property="og:url" content="https://yttoolbox.example.com/tools/thumbnail" />
    <link rel="canonical" href="https://yttoolbox.example.com/tools/thumbnail" />
  </svelte:head>
  
  <!-- Copy the thumbnail section from the original file, starting from the div with class="max-w-5xl" -->
  <div class="max-w-5xl mx-auto px-4 py-8">
    <h1 class="text-2xl md:text-3xl font-bold text-center text-gray-800 mb-2">YouTube Thumbnail Downloader</h1>
    <p class="text-center text-gray-600 mb-6">Download high-quality thumbnails from any YouTube video</p>
  
    <ToolNav currentTool="thumbnail" />
