...
<svelte:head>
  ...
  <meta property="og:url" content="https://yttoolbox.example.com/tools/title-extractor" />
  <link rel="canonical" href="https://yttoolbox.example.com/tools/title-extractor" />
</svelte:head>
